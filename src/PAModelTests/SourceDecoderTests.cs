...
namespace PAModelTests
{
    ...
    public class SourceDecoderTests
    {
        ...
        [DataTestMethod]
        [DataRow("MyWeather.msapp", "Screens\\Screen1.pa.yaml", "Weather_Screen1.pa.yaml")]
        [DataRow("GalleryTestApp.msapp", "Screens\\Screen1.pa.yaml", "Gallery_ScreenTest.pa.yaml")]
