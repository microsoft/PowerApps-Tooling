...
public class ExampleGeneratorTests
{
    ...
    public void DebuggingSourceGeneratorTest()
    {
        ...
        var foo = new PrefixedByValid("ValidPrefix_foo");
...
[TypedString]
public partial record PrefixedByValid
{
    public static bool IsValid([NotNullWhen(true)] string? value) => !string.IsNullOrEmpty(value) && value.StartsWith("ValidPrefix_", StringComparison.Ordinal);
}


[TypedString]
public partial record OddString
{
    public static bool IsValid([NotNullWhen(true)] string? value) => value?.Length % 2 == 1;
}
